...
const GoogleReview = () => {
    return (
        <div className="flex justify-center items-center p-4 bg-gray-800 py-20">
            {/* <!-- Elfsight Google Reviews | Untitled Google Reviews --> */}
            <script src="https://static.elfsight.com/platform/platform.js" async></script>
            <div className="elfsight-app-e0afc3c1-eccb-4e8a-90d9-654af3f909b1" data-elfsight-app-lazy></div>
        </div>
    );
}
