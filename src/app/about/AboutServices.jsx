...
import islamic_box from '../assets/services/view-3d-islamic-mecca-cube.jpg'
import ig2 from '../assets/services/1461.jpg'
                ...
                <div className="flex gap-4">
                    ...
                    <div>
                        <ul className="mt-16 grid grid-cols-1 gap-4 text-center text-slate-700 md:grid-cols-2">
                            ...
                            <Image src={islamic_box} width={280} height={'auto'} className="boj-cover" alt='ser' />
                            <Image src={ig2} width={280} height={'auto'} className="boj-cover" alt='ser' />
