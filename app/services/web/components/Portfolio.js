...
const Portfolio = () => {
    return (
        <>
            <div className=" mx-auto max-w-7xl py-16" id='portfolio'>
                <h2 className="my-2 text-center text-3xl text-amber-500 uppercase font-bold">Products</h2>
                <div className='flex justify-center'>
                    <div className='w-24 border-b-4 border-amber-500 mb-8'></div>
                </div>

                <div className="px-4 sm:px-4 md:px-0" data-aos="fade-down" data-aos-delay="600">
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 border hover:border-amber-500  hover:scale-105 rounded-lg p-3 min-h-max">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 ">Business Management System</h4>
                                ...
                                <div className="flex justify-center my-4">
                                    <Link href="/get-demo" className="text-white bg-amber-500 hover:text-amber-500 hover:bg-white border hover:border-amber-500  inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg rounded-xl">
                                        Schedule Demo
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 border hover:border-amber-500  hover:scale-105 rounded-lg p-3">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 ">School Management Portal</h4>
                                <p className="text-md font-medium leading-5 ">
                                ...
                                <div className="flex justify-center my-4">
                                    <Link href="/get-demo" className="text-white bg-amber-500 hover:text-amber-500 hover:bg-white border hover:border-amber-500  inline-flex items-center justify-center w-full px-6 py-3 my-4 text-lg shadow-xl rounded-xl">
                                        Schedule Demo
                                        <svg className="w-4 h-4 ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                                    </Link>
                                </div>
                        ...
                        <div className="bg-white  transition-all ease-in-out duration-400  overflow-hidden text-gray-700 border hover:border-amber-500  hover:scale-105 rounded-lg p-3">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 ">Payroll Management System</h4>
                                <p className="text-md font-medium leading-5 ">
                        ...
                        <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 border hover:border-amber-500  hover:scale-105 rounded-lg p-3">
                            <div className="m-2 text-justify text-sm">
                                <h4 className="font-semibold my-4 text-lg md:text-2xl text-center mb-4 ">Event Management System</h4>
                                <p className="text-md font-medium leading-5 ">
