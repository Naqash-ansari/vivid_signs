...
import img2 from '../images/ser1.png';
// import img3 from '../images/hosting.svg';
import img3 from '../images/ser2.png';
...
const Services = () => {
    ...
    return (
        <div className='bg-gray-100 '>
            <div id="services" className=" mx-auto max-w-7xl pt-16" >
                <section data-aos="zoom-in-down">
                    <div className="my-4 py-4">
                        <h2 className="my-2 text-center text-3xl text-amber-500 uppercase font-bold">services</h2>

                        <div className='flex justify-center'>
                            <div className='w-24 border-b-4 border-amtext-amber-500'></div>
                        </div>
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-amber-500">We are deeply committed to the growth and success of our clients.</h2>
                    </div>

                    <div className="px-4 sm:px-4 md:px-12" data-aos="fade-down" data-aos-delay="600">
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">

                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    <Image width={500} height={500} alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    <Image width={500} height={500} alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} />
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400 overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-sm text-center">
                                    <Image
                                        ...
                                        alt="card img"
                                        src={img3}
                                        className="block mx-auto rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out"
                                    />
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    <Image width={500} height={500} alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                    ...
                    <div className="m-auto max-w-6xl h-5/6 px-4 sm:px-6 md:px-0">
                        <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left" data-aos="zoom-out">
                            ...
                            <div className="lg:w-1/2 flex flex-col lg:mx-4 justify-center">
                                ...
                                <h3 className="text-3xl  text-amber-500 font-bold">We <span className='font-black'>Collaborate</span></h3>
                                <div>
