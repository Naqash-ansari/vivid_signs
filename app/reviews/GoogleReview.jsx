    ...
    return (
        <section id="testimonies" className="py-20 bg-slate-900">
            <div className="max-w-6xl mx-8 md:mx-10 lg:mx-20 xl:mx-auto">
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-4 lg:gap-8">
                    ...
                    <ul className="space-y-8">
                        <li className="text-sm leading-6">
                            <div className="relative group">
                                <div
                                    className="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-amber-600
                                     to-pink-600 blur duration-400 group-hover:opacity-100 group-hover:duration-200">
                        ...
                        <li className="text-sm leading-6">
                            <div className="relative group">
                                <div
                                    className="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-amber-600 to-pink-600 blur duration-400 group-hover:opacity-100 group-hover:duration-200">
                            ...
                            <div className="relative group">
                                <div
                                    ...
                                    <div
                                        className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                                        <div className="flex justify-center items-center text-center w-full">
                                            <Image width={150} height={100} src={logo1} alt="image" />
                                        </div>
                                        <div className="flex items-center space-x-4"><img
                            ...
                            <div className="relative group">
                                <div
                                    ...
                                    <div
                                        className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                                        <div className="flex justify-center items-center text-center w-full">
                                            <Image width={150} height={100} src={logo2} alt="image" />
                                        </div>
                                        <div className="flex items-center space-x-4"><img
                            ...
                            <div className="relative group">
                                <div
                                    ...
                                    <div
                                        className="relative p-6 space-y-6 leading-none rounded-lg bg-slate-800 ring-1 ring-gray-900/5">
                                        <div className="flex justify-center items-center text-center w-full">
                                            <Image width={150} height={100} src={logo3} alt="image" />
                                        </div>
                                        <div className="flex items-center space-x-4"><img
                                            src="https://pbs.twimg.com/profile_images/1221837516816306177/_Ld4un5A_400x400.jpg"
                                            className="w-12 h-12 bg-center bg-cover border rounded-full" alt="Satya Nadella" />
